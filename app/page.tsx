...
export default function HomePage() {
  ...
  blur-[180px] rounded-full top-[-300px] left-[-300px]"
        ...
        <motion.div
          ...
          className="
  relative z-10 px-4 mb-10 text-center
  md:absolute md:text-left
  md:top-[20%] md:left-[calc(50%-250px)]
"
        >
      ...
      <motion.section
        ...
        className="relative z-10 min-h-screen md:h-screen flex flex-col items-center justify-center text-center px-6 gap-8"
      >
        <span className="px-3 py-1 text-xs sm:text-sm bg-white/10 border border-white/20 rounded-full backdrop-blur-md">
          Trusted by 5,000+ users
        </span>
        <div className="container mx-auto max-w-6xl">
          <motion.div style={{ x, y }}>
            <h1 className="text-3xl sm:text-4xl md:text-7xl font-extrabold mb-6 leading-tight drop-shadow-[0_10px_30px_rgba(0,0,0,0.6)]">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 mb-10 drop-shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
            ...
            {user ? (
              <motion.div whileTap={{ scale: 0.95 }}>
                <Link href="/dashboard">
                  <Button
                    size="lg"
                    className="flex items-center gap-2 px-5 py-3 sm:px-4 sm:py-2 text-sm sm:text-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white shadow-[0_0_30px_rgba(139,92,246,0.6)] hover:scale-105 transition-all duration-300"
                  >
                    Go to Dashboard
      ...
      {/* ================= FEATURES ================= */}
      <motion.section
        className="relative z-10 min-h-screen md:h-screen flex items-center justify-center px-6"
      ...
      >
        ...
        <div className="container mx-auto max-w-7xl space-y-20">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-center mb-6 drop-shadow-[0_4px_20px_rgba(0,0,0,2)]">
            How It Works
          </h2>
          ...
          >
            ...
            {[
              ...
              <motion.div
                ...
                className="p-5 md:p-8 rounded-2xl backdrop-blur-xl bg-white/10 border border-white/20 flex flex-col md:block gap-2
text-center md:text-left gap-4"
              >
                <feature.icon className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-purple-400 mb-3 sm:mb-4 drop-shadow-[0_0_10px_rgba(139,92,246,0.8)]" />{" "}
      ...
      {/* ================= STATS ================= */}
      <motion.section
        className="relative z-10 min-h-screen md:h-screen flex flex-col justify-center px-6"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-8 text-center">
            {[
              ...
              <motion.div
                ...
                className="p-3 md:p-6 rounded-xl bg-gradient-to-br from-white/5 to-transparent border border-white/10 backdrop-blur-lg shadow-[0_20px_60px_rgba(0,0,0,0.6),0_0_40px_rgba(139,92,246,0.25)]"
              >
                <div className="text-lg sm:text-2xl md:text-5xl font-extrabold text-transparent bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text">
                  {stat.value}
                </div>
      ...
      >
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6 gap-4 md:gap-6">
            {[
              ...
              <motion.div key={idx} whileHover={{ scale: 1.01 }}>
                <div className="p-4 md:p-6 rounded-xl text-center bg-gradient-to-br from-white/5 to-transparent border border-white/10 backdrop-blur-lg shadow-[0_20px_60px_rgba(0,0,0,0.6),0_0_40px_rgba(139,92,246,0.25)] hover:shadow-[0_0_60px_rgba(59,130,246,0.3)] transition hover:scale-105">
      ...
      {/* ================= TRUST ================= */}
      <motion.section
        className="relative z-10 min-h-screen md:h-screen flex flex-col items-center justify-center px-6 gap-6"
      ...
      >
        ...
        <div className="container mx-auto max-w-3xl animate-fadeUp">
          <div className="p-6 sm:p-8 md:p-10 rounded-2xl bg-gradient-to-br from-purple-600/10 to-transparent border border-purple-400/20 backdrop-blur-xl shadow-[0_0_80px_rgba(139,92,246,0.2)] text-center">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 py-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm sm:text-base md:space-y-2">
              {" "}
              <li>
